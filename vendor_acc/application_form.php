...
$vendor_id = $_COOKIE['vendor_id'] ?? null;
...
<body>
    ...
    <section class="register_form">
        ...
        <div class="container">  
            <div class="forms">
                <form action="/api/process_vendor.php?vendor_id=<?php echo $vendor_id; ?>" method="POST" enctype="multipart/form-data" id="form">
