...
if (isset($_COOKIE['vendor_id'])) {
    ...
    $sql = "SELECT username, phone, email FROM vendor WHERE id='$vendor_id'";
    ...
    $sql1= "SELECT reviews.vendorpage_id, reviews.user_id,reviews.rating, reviews.comment, user.username FROM reviews
    JOIN vendorpages ON reviews.vendorpage_id = vendorpages.id
    JOIN user ON reviews.user_id = user.id
    WHERE vendorpages.vendor_id = '$vendor_id'";
    ...
    $sql2 = "SELECT views_history FROM vendor WHERE id = ?";
    ...
    $sql3 = "SELECT id, vendor_name, main_photo_path FROM vendorpages WHERE vendor_id='$vendor_id'";
    $result3 = $mysqli->query($sql3);
} else {
    echo "Not found the vendor ID";
}
?>
...
<body>
        ...
        <div class="container">
            <div class="wrapper">
                ...
                <div id="content-areas">
                        ...
                        <div class="column_content">
                            <div class="profile">
                                ...
                                <div class="phone_number">
                                    <label id="phone-label"><?php if (isset($phone_number)) {$formatted_phone_number = substr($phone_number, 0, 3) . '-' . substr($phone_number, 3);echo $formatted_phone_number;}?></label>
                                </div>
                    ...
                    <div class="column content-section" id="dashboard_content">
                        <div class="column_content" id="lable">
                            <label>Your Vendorpage</label>
                            <?php if ($result3->num_rows > 0):?>
                                <?php $row = $result3->fetch_assoc(); ?>
                                <a class="vendorpage" href="/FYP/vendorpage/<?php echo $row['vendor_name']; ?>.html">
                                    <div>
                                        <div class="detail">
                                            <div class="img">
                                                <img src="/FYP/vendorpage/img_vendor/vendorpage_<?php echo $row['vendor_name']; ?>/vendor_img/<?php echo $row['main_photo_path']; ?>">
                                            </div>
                                            <div class="info">
                    ...
                    <div class="column content-section" id="history_content">
                        <div class="column_content">
                            <div class="history">
                                ...
                                <?php
                                if (is_array($view_history) || is_object($view_history)) {
                        ...
                        <div class="column_content">
                            <div class="feedback">
                                <div class="feedback_content">
                                    ...
                                    <button type="button" name="feedback_submit">Submit</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script src="/web/assets/js/vendor_profile.js"></script>
    <script>
        document.addEventListener("DOMContentLoaded", function() {
                ...
                let vendorId = getCookie('vendor_id');
                let userType = getCookie('user_type'); 
                
                if (vendorId && userType === 'vendor') {
                    homepageLink.href = "/vendor_acc/vendor_account.php";
                } 
            });
