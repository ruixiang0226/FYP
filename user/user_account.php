...
<meta charset="utf-8">
    ...
    <title>Welcome <?php echo $username; ?> to Penang Local Food Website</title>
            ...
            <header>
                ...
                <div class="header_icons">
                    <div class="icon" id="header_acc">
                        <a class="icon_link" href="/user/user_profile.php">
                            <i class='bx bx-user-circle'></i>
                            <span class="icon_label"><?php echo $username; ?></span>
                        </a>
                    </div>
                    ...
                    <div class="search_container">
                        <div class="search_box">
                            ...
                            <div class="search_input">
                                <input type="search" autocomplete="off" placeholder="Searching restaurant, cuisines type, location..." value>
                            </div>
                        </div>
                    </div>
                </div>
